...
public class ProductDTO {
    ...
    public ProductDTO(int productID, String productName, String image, int price, int quantity, String categoryID, String importDate, String usingDate, int status) {
